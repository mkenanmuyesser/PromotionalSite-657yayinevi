<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Root.Master" AutoEventWireup="true" CodeBehind="Kurslarimiz.aspx.cs" Inherits="Yayinevi_657_Project.Kurslarimiz" %>
    ...
    <section id="navbar" class="clearfix">
        <nav id="nav">
            <ul id="navlist" class="clearfix">
                ...
                <li class="current"><a href="Kurslarimiz.aspx" data-rel="submenu2">KURSLARIMIZ</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <section id="content" class="container clearfix">
        ...
        <ul >
            <asp:Repeater ID="DataListKitaplar" runat="server">
                <ItemTemplate>
                    <li data-id="id-11" data-type="photography" class="entry one-one">

                ...
                if(!initPerformed){
                    ...
                    if(slider.children('li').length > 1){
                        if(slider.parent().find('#'+prevButtonId).length==0){
                            slider.parent().append('<div class="entry-slider-nav"><a id="'+prevButtonId+'" class="prev">Prev</a><a id="'+nextButtonId+'" class="next">zNext</a></div>');
                        }
                    }
    ...
    function lightbox(){
        if($().fancybox){
            ...
            $(".fancybox").fancybox({
                ...
                beforeLoad: function () {
                    this.title = '';
                    //this.title = 'Resim ' + (this.index + 1) + ' - ' + this.group.length ;
